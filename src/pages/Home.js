...
export default function Home() {
    ...
    const { refreshFavourites, isUserLoggedIn } = useUser();
    const {
        filters,
        setFilters,
        breeds,
    ...
    const anyError =
        petsError || filtersError.breeds || filtersError.species || filtersError.shelters || filtersError.tags;

    const { page, totalPages, paginatedItems, handlePageChange } = usePagination(filteredPets, 12);
